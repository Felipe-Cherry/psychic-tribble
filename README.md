## EpsilonTek: Base de datos DEBEDE
Este proyecto surge como respuesta a la creciente necesidad de digitalización en la industria de los videojuegos, especialmente entre pequeñas tiendas que no cuentan con los recursos suficientes para desarrollar sus propias plataformas de venta online. Es por eso que EpsilonTek, ha diseñado una solución base que permite a estas tiendas gestionar y vender sus productos de forma eficiente a través de una plataforma web.

## **Integrantes**

| Nombre      | Nombre de usuario |
|---------------------|-------------------|
| Amaro Rojas         | [Kmaron27](https://github.com/Kmaron27)          |
| María Fernanda      | [mariaverdecia](https://github.com/mariaverdecia)     |
| Santiago Aguirre    | [wantiwantiwan](https://github.com/wantiwantiwan)     |
| Manuel Quezada      | [Manuel-qv](https://github.com/Manuel-qv)         |
| Felipe Pérez        | [Felipe-Cherry](https://github.com/Felipe-Cherry)     |
